...
from image_catalog_database import select_image_catalog
...
def quantity_show(image_catalog_list, date, resort):

   image_sum = len(image_catalog_list)

   column = sl.columns([1, 1, 2])
...
def select_section(date, resort):
   ...
   quantity_show(image_catalog_list, date, resort)

   return image_catalog_list, date, resort
